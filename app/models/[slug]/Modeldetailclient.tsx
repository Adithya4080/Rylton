...
export default function ModelDetailClient({ scooter }: ModelDetailClientProps) {
  ...
  return (
    // KEY FIX: overflow-x-hidden on the root prevents any child from causing horizontal scroll
    <div className="min-h-screen pt-20 overflow-x-hidden">
      {/* Product Header */}
      <section className="py-10 sm:py-16 bg-linear-to-br from-dark-900 via-dark-800 to-dark-900 relative">
        <div className="absolute inset-0 grid-bg opacity-30"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* KEY FIX: stack on mobile (grid-cols-1), side-by-side on lg+ */}
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            {/* Image Gallery */}
            <div className="space-y-4 w-full min-w-0">
              {/* Main Image — KEY FIX: use aspect-ratio instead of fixed h-[500px] */}
              <div className="relative w-full aspect-[4/3] sm:aspect-[16/10] rounded-2xl overflow-hidden bg-dark-800 border border-dark-700">
                <Image
                  src={scooter.images[selectedImage]}
                  alt={scooter.name}
                  fill
              ...
              {/* Thumbnails — KEY FIX: grid-cols-4 kept but constrained by parent width */}
            ...
            <div className="space-y-6 sm:space-y-8 w-full min-w-0">
              <div>
                ...
                {/* KEY FIX: smaller font on mobile to prevent overflow */}
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-4">
                <div className="card text-center !p-3 sm:!p-4">
                  <div className="text-2xl sm:text-3xl font-bold text-primary-500 mb-1">
                    {scooter.range}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-400">km Range</div>
                </div>
                <div className="card text-center !p-3 sm:!p-4">
                  <div className="text-2xl sm:text-3xl font-bold text-primary-500 mb-1">
                    {scooter.topSpeed}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-400">km/h Speed</div>
                </div>
                <div className="card text-center !p-3 sm:!p-4">
                  <div className="text-2xl sm:text-3xl font-bold text-primary-500 mb-1">
                    {scooter.chargingTime}
                  </div>
                  <div className="text-xs sm:text-sm text-gray-400">hrs Charge</div>
                </div>
              </div>
      ...
      {/* Features */}
      <section className="py-12 sm:py-16 bg-dark-800/30 relative">
        <div className="absolute inset-0 grid-bg opacity-20"></div>
        
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="font-display text-2xl sm:text-3xl font-bold mb-6 sm:mb-8">Key Features</h2>
      ...
      {/* Specifications */}
      <section className="py-12 sm:py-16 relative bg-[#f1f5f9]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Header with icon */}
          ...
          {/* KEY FIX: 2 cols on mobile, 3 on md, 6 on lg */}
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-3 sm:gap-6">
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Range</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.range} km</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Top Speed</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.topSpeed} km/h</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Motor Power</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.motorPower}</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Battery</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.batteryType}</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Charging Time</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.chargingTime} hours</div>
            </div>
            ...
            <div className="bg-white rounded-2xl p-4 sm:p-6 shadow-sm hover:shadow-md transition-shadow">
              ...
              <div className="text-xs sm:text-sm text-gray-500 mb-1">Load Capacity</div>
              <div className="text-base sm:text-xl font-bold text-gray-900">{scooter.loadCapacity}</div>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* EMI Calculator */}
      <section className="py-12 sm:py-16 bg-dark-800/50 relative">
        <div className="absolute inset-0 grid-bg opacity-20"></div>
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="card">
            ...
            <div className="space-y-6">
              ...
              {/* EMI Result */}
              <div className="bg-gradient-to-br from-primary-500/10 to-dark-800 border border-primary-500/30 rounded-xl p-6 sm:p-8 text-center">
                <div className="text-gray-400 mb-2">Your Monthly EMI</div>
      ...
      {/* CTA Section */}
      <section className="py-16 sm:py-20 bg-linear-to-r from-primary-500/10 to-dark-900 relative">
        <div className="absolute inset-0 grid-bg opacity-20"></div>
